...
import "./login.css";
import { loginApi } from "../../api/auth";  // <-- dùng API thật
  ...
  return (
    <div className="bg-full">
      ...
      <div className="card">
        ...
        {/* (Nếu muốn, có thể xoá phần demo info này luôn) */}
        <div className="demo">
          <p><b>Tài khoản thật do backend quản lý.</b></p>
        </div>
      </div>
